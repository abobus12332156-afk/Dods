...
-- Gaming
local gamingApps = "^(steam_app_*|gamescope|Minecraft*)$"
...
hl.window_rule({
  name = "DS-opaque",
  match = { class = "steam_app_1850570" },
  opaque = true,
  opacity = "1.0 override 1.0 override"
})

hl.window_rule({
  name = "Minecraft-opaque",
